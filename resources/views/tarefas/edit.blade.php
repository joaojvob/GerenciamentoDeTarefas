<div id="editTarefaModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-1/3">
        ...
        <form id="editTarefaForm">
            <input type="hidden" id="editTarefaId" name="tarefa_id" value="">
            @csrf
            <div class="mb-4">
            ...
            <div class="flex justify-end">
                <button type="button" id="cancelEditTarefa" class="bg-gray-500 text-white py-2 px-4 rounded mr-2">
                    Cancel
                </button>
